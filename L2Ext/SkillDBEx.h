...
public:
	...
	bool geoDataTest;
	int staticReuseTime;
	CSkillInfoEx() : id(0), level(0), geoDataTest(0), soulshotBonus(0), damageBonus(0), avoidShieldBlock(false), magicShieldBlock(false), directToHp(false), staticReuseTime(0) { }
};
